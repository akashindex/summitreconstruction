...
function Navtop() {
  return (
    <div className='w-[1200px] mx-auto flex items-center gap-[30px] justify-center py-4 max-sm:flex-col max-sm:w-[100%]'>
        <span className="font-bold text-[white] md:text-[18x] sm-max:text-[14px]">
        24/7 Phone | <a href="#" className="text-[white]">(503) 451-3544</a>
    </span>
